...
export class IssuerComponent implements OnInit {
  ...
  constructor(private serviceIssuer:IssuerService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "org.isthmus.invoice.Issuer",
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceIssuer.updateParticipant(form.get("userId").value,this.participant)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
